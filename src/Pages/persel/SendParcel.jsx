      ...
      <form className="space-y-4" onSubmit={handleSubmit(handleFormSubmit)}>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10 mb-10">
          <div className="flex-1">
            <Input label="Parcel Name" {...register("parcelName")} />
          </div>
          <div className="flex-1">
            <Input label="Parcel Weight (KG)" {...register("parcelWeight")} />
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="flex-1">
            <h1 className="text-2xl font-black text-gray-700 mb-5">
              Sender Details
            </h1>
            ...
            <fieldset className="fieldset mb-4">
              <legend className="block text-gray-600 text-xl font-semibold mb-1">
                Sender Region
              </legend>
              ...
              <select
                ...
                className="select text-lg font-medium"
              >
            ...
            <fieldset className="fieldset mb-4">
              ...
              <select
                ...
                className="select text-lg font-medium"
              >
                {districtByRegion(senderRegion).map((d, idx) => (
          ...
          <div className="flex-1">
            ...
            <fieldset className="fieldset mb-4">
              ...
              <select
                ...
                className="select text-lg font-medium"
              >
                {districtByRegion(receiverRegion).map((d, idx) => (
                  <option key={idx} value={d}>
                    {d}
                  </option>
                ))}
